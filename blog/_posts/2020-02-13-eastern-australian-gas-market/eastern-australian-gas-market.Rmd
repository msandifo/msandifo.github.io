...
An analysis motivated by the question of reservation of Queensland CSG (coal seam) gas production and the amount needed to restore domestic supply to pre-2015 levels (i.e., prior to opening of the LNG export facility at Curtis Island, Gladstone).
