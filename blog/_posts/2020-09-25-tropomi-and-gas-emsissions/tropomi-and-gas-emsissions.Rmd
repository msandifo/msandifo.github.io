...
Now averaging around 50 million tones (CH_4_) per year, shale gas production accounts for all the growth in production since 2006, and more  (Fig. \@ref(fig:fig-dry-gas)).  
...
An intriguing feature of the The growth in US 


A feature in many of the shale gas producing regions is the large extent of gas flaring.
In the Permian Basin, [Rystad](https://www.rystadenergy.com/newsevents/news/press-releases/a-downturn-silver-lining-permian-gas-flaring-has-decreased-and-is-expected-to-fall-further-in-2020/) estimates an average of  over 800 Mmcf per day flaring across the 12 month period Quarter 4 2018 to Quarter 3 2019  (Fig. \@ref(fig:fig-ry)). 
For example in the [Bakken in the Williston Basin](https://en.wikipedia.org/wiki/Bakken_Formation) gas flaring lights are clearly  (Fig. \@ref(fig:fig-sat)).

```{r fig-ry, echo=FALSE, fig.cap="ERystad estimates of gas flaring in the Permian Basin, by quarter - sourced from [https://www.rystadenergy.com/newsevents/news/press-releases/a-downturn-silver-lining-permian-gas-flaring-has-decreased-and-is-expected-to-fall-further-in-2020/](https://www.rystadenergy.com/newsevents/news/press-releases/a-downturn-silver-lining-permian-gas-flaring-has-decreased-and-is-expected-to-fall-further-in-2020/)",  cache=TRUE}
...
```{r fig-sat, echo=FALSE, fig.cap="Baken flareing  source from [https://geology.com/articles/oil-fields-from-space/#bakken-formation](https://geology.com/articles/oil-fields-from-space/#bakken-formation)",  cache=TRUE}
...
Like many of the U.S. shale gas plays,  in the Bakken it is oil is the principal commodity driving investment in the Bakken. The Bakken produced about `r paste0(mean(bakken.oil$p[bakken.oil$year %in% 2018:2019]), "%")` of U.S. tight oil across 2018 and 2010, whereas it produced only `r paste0(mean(bakken.gas$p[bakken.gas$year %in% 2018:2019]), "%")` of U.S dry gas production (cf. Figs \@ref(fig:fig-dry-gas) & \@ref(fig:fig-tight-oil)). 
