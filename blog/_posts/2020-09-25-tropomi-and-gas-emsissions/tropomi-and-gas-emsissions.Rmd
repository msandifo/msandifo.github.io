...
ex.nd.viirs <- data.frame(mmcf=(pf.ndg.y %>% subset(name=="bakken" & year==2019))$value*av.nd.viirs , date=ymd("2019-07-01"), name="bakken") 
pf.p.001b + 
...
<!-- `r mean(tail(100*north.dakota.totals$mmcf/(pf.ndg.y %>% subset(name=="bakken" & year<2019 &year>2011))$value ,-1)) %>% round()`%  -->
higher than the flared volumes reported by ..


## CO~2~-e emissions 

For the Bakken, @s estimates total methane venting form all sources across 2018 and 2019 average 0.89±0.56 millions tonnes per year. As shown in Table that is simmilar to wht 1.02 million tonnes average of the "unaccounted" gas. Assuming that the "unaccounted" gas in the North Dakota is a proxy for the venting  then we can make an estimate of the CO~2~-equivalent budget summing the flared gas as  CO~2~, assuming 100% efficiency, and the methane venting at an appropriate time scale. Figs ... show the CO2-e  using global worming potential for CH~4~ appropriate to 20 yeras (x86 CO~2~ GWP) and 100 years (x 34 CO~2~ GWP)
