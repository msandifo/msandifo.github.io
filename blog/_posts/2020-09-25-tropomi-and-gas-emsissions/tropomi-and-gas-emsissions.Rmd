...
```{r fig-ndg-flare, echo=FALSE, fig.cap="Estimates of gas flaring in the  Bakken by quarter, data from North Dakota Industrial Commission, https://www.dmr.nd.gov/oilgas/stats/Gas1990ToPresent.xls. Diamonds are flaring estimates from VIIRS satellite analysis.",  cache=TRUE}
setwd("~/Dropbox/msandifo/documents/programming/r/2020/flare/")
pf.p.001b + 
...
The estimates of flaring in the Bakken are significantly higher than the flaring volumes reported by the `r read_data("north.dakota.gas")$agency`.
