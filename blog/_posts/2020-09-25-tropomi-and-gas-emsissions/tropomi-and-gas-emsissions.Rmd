...
source('r/permian_flaring_rystad.R')
 ...
 viirs.2017<-VIIRS_bakken(year=2017)
  viirs.2018<-VIIRS_bakken(year=2018)
do.plots=T
...
```{r fig-viirs, echo=FALSE, fig.cap="Estimates of gas flaring in the  Bakken for 2018, from VIIRS",fig.height=10 }

  cowplot::plot_grid( viirs.2017$plot, viirs.2018$plot, ncol=1)
...
setwd("~/Dropbox/msandifo/documents/programming/r/2020/flare/")
pf.p.001a + geom_point(data=  viirs.2017$total %>% mutate(year=ymd("2017-07-01"), name="bakken"), aes(year,mmcf), size=3, shape=5)+ geom_point(data=  viirs.2018$total %>% mutate(year=ymd("2018-07-01"), name="bakken"), aes(year,mmcf), size=3, shape=5)
setwd(blog.dir)
