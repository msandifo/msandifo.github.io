...
```{r fig.cap="View across the Ainaro fan, with Cablaci in the background." }
knitr::include_graphics("images/IMG_3457.jpeg")
```
...
```{r fig.cap="Jakarts dua, south of Ainaro" }
knitr::include_graphics("images/P1270627.jpeg")
```
...
```{r fig.cap="The crocodile's tail -  Ainaro region." }
knitr::include_graphics("images/P1300683.jpeg")
```

### Postscript
        
For those interested in the grim details of  “Jakarta dua”, an account of Max Stahl’s visit to the site in 1999  has been [posted](https://lists.riseup.net/www/arc/east-timor/2016-04/msg00096.html). It makes confronting reading and confirms my worst fears. [Max Stahl](https://en.wikipedia.org/wiki/Christopher_Wenner)  has played a pivotal role in documenting the atrocities committed in Timor Leste, including the filming of the [Santa Cruz massacre](ttps://en.wikipedia.org/wiki/Santa_Cruz_massacre) in 1991.  
